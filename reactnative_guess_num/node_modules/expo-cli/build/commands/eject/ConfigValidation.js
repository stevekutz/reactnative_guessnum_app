...
function logNoConfig() {
  _log().default.log(_log().default.chalk.yellow('No Expo config was found. Please create an Expo config (`app.config.js` or `app.json`) in your project root.'));
}
...
function notifyAboutManualConfigEdits(edits) {
  _log().default.log(_log().default.chalk.cyan(`Please add the following to your Expo config, and try again... `));
